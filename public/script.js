function talkToTheFriend(){
	// console.log('Friend Function Called')
	window.alert('Friend Function Called')
	...
	peerConnection.createOffer().then((offer) => {
		...
		fetch('/session')
			...
			.then((data) => {
				...
				// if (!data || !data.result || !data.result.client_secret || !data.result.client_secret.value) {
